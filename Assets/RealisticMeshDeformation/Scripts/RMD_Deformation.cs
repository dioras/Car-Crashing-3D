...
public class RMD_Deformation : MonoBehaviour {
    ...
    [SerializeField] RCC_DetachablePart[] detachableParts;
    ...
    private void OnEnable() {
        ...
        detachableParts = body.GetComponentsInChildren<RCC_DetachablePart>(true);
    ...
    {
        if(!audioSource.isPlaying)
            audioSource.PlayOneShot(crashSounds[2]);
    }
