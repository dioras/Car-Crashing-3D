...
public class RMD_Editor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("body"), new GUIContent("Mesh Body"));
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("detachableParts"), new GUIContent("Detachable Parts","List of parts to be detached."));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("crashSounds"), new GUIContent("Crash Sounds"));
        EditorGUILayout.Space();
    ...
    public void AddAllMeshes() {
        ...
        MeshFilter[] allMeshFilters = prop.body.gameObject.GetComponentsInChildren<MeshFilter>(true);
