  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float3 finalColor_5;
          float3 tmpvar_6;
          tmpvar_6 = tex2D(_Texture, in_f.xlv_TEXCOORD1).xyz.xyz;
          ...
          float _tmp_dvx_0 = (dirtTex_4.w * dirtFactor_2);
          finalColor_5 = (lerp(finalColor_5, dirtColor_3.xyz, float3(_tmp_dvx_0, _tmp_dvx_0, _tmp_dvx_0)) * in_f.xlv_COLOR0);
          float4 tmpvar_10;
          tmpvar_10.w = 1;
