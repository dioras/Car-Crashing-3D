...
namespace GeNa
{
	public class NoiseGenerator
	{
		...
		{
			int num = NoiseGenerator.FastFloor(x);
			int num2 = num + 1;
			float num3 = x - (float)num;
			float num4 = num3 - 1f;
			float num5 = 1f - num3 * num3;
			num5 *= num5;
			float num6 = num5 * num5 * NoiseGenerator.Grad((int)NoiseGenerator.perm[num & 255], num3);
			float num7 = 1f - num4 * num4;
			num7 *= num7;
			float num8 = num7 * num7 * NoiseGenerator.Grad((int)NoiseGenerator.perm[num2 & 255], num4);
		...
		public static float Generate(float x, float y)
		{
			...
			float x2 = x + num;
			float x3 = y + num;
			int num2 = NoiseGenerator.FastFloor(x2);
			int num3 = NoiseGenerator.FastFloor(x3);
			...
			{
				num17 *= num17;
				num18 = num17 * num17 * NoiseGenerator.Grad((int)NoiseGenerator.perm[num15 + (int)NoiseGenerator.perm[num16]], num7, num8);
			}
			...
			{
				num19 *= num19;
				num20 = num19 * num19 * NoiseGenerator.Grad((int)NoiseGenerator.perm[num15 + num9 + (int)NoiseGenerator.perm[num16 + num10]], num11, num12);
			}
			...
			{
				num21 *= num21;
				num22 = num21 * num21 * NoiseGenerator.Grad((int)NoiseGenerator.perm[num15 + 1 + (int)NoiseGenerator.perm[num16 + 1]], num13, num14);
			}
		...
		public static float Generate(float x, float y, float z)
		{
			...
			int num2 = NoiseGenerator.FastFloor(x2);
			int num3 = NoiseGenerator.FastFloor(x3);
			int num4 = NoiseGenerator.FastFloor(x4);
			...
			int num27 = NoiseGenerator.Mod(num2, 256);
			int num28 = NoiseGenerator.Mod(num3, 256);
			int num29 = NoiseGenerator.Mod(num4, 256);
			...
			{
				num30 *= num30;
				num31 = num30 * num30 * NoiseGenerator.Grad((int)NoiseGenerator.perm[num27 + (int)NoiseGenerator.perm[num28 + (int)NoiseGenerator.perm[num29]]], num9, num10, num11);
			}
			...
			{
				num32 *= num32;
				num33 = num32 * num32 * NoiseGenerator.Grad((int)NoiseGenerator.perm[num27 + num12 + (int)NoiseGenerator.perm[num28 + num13 + (int)NoiseGenerator.perm[num29 + num14]]], num18, num19, num20);
			}
			...
			{
				num34 *= num34;
				num35 = num34 * num34 * NoiseGenerator.Grad((int)NoiseGenerator.perm[num27 + num15 + (int)NoiseGenerator.perm[num28 + num16 + (int)NoiseGenerator.perm[num29 + num17]]], num21, num22, num23);
			}
			...
			{
				num36 *= num36;
				num37 = num36 * num36 * NoiseGenerator.Grad((int)NoiseGenerator.perm[num27 + 1 + (int)NoiseGenerator.perm[num28 + 1 + (int)NoiseGenerator.perm[num29 + 1]]], num24, num25, num26);
			}
		...
		{
			return Mathf.Clamp((NoiseGenerator.Generate(x, y) + 1f) / 2f, 0f, 1f);
		}
