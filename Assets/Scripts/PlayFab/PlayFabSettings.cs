...
namespace PlayFab
{
	public static class PlayFabSettings
	{
		...
		{
			return PlayFabSettings.GetSharedSettingsObjectPrivate();
		}
		...
		public static string DeveloperSecretKey
		{
			internal get
			{
				return PlayFabSettings.PlayFabSharedPrivate.DeveloperSecretKey;
			}
			set
			{
				PlayFabSettings.PlayFabSharedPrivate.DeveloperSecretKey = value;
			}
		}
