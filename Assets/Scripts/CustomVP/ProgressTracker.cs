...
namespace CustomVP
{
	public class ProgressTracker : MonoBehaviour
	{
		...
		public void Reset()
		{
			...
			this.progressNum = 0;
			if (this.progressStyle == ProgressTracker.ProgressStyle.PointToPoint)
			{
		...
		private void Update()
		{
			if (this.progressStyle == ProgressTracker.ProgressStyle.SmoothAlongRoute)
			{
		...
		[SerializeField]
		private ProgressTracker.ProgressStyle progressStyle;
