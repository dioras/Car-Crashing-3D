...
namespace CustomVP
{
	public class WaypointRoute : MonoBehaviour
	{
		...
		public WaypointRoute.RoutePoint GetRoutePoint(float dist)
		{
			Vector3 routePosition = this.GetRoutePosition(dist);
			Vector3 routePosition2 = this.GetRoutePosition(dist + 0.1f);
			return new WaypointRoute.RoutePoint(routePosition, (routePosition2 - routePosition).normalized);
		}
		...
		public WaypointRoute.WaypointList waypointList = new WaypointRoute.WaypointList();
